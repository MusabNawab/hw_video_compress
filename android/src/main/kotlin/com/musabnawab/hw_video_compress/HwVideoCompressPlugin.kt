package com.musabnawab.hw_video_compress
...
/** HwVideoCompressPlugin */
class HwVideoCompressPlugin :
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "hw_video_compress")
    channel.setMethodCallHandler(this)
    
    progressChannel = EventChannel(flutterPluginBinding.binaryMessenger, "hw_video_compress_progress")
    ...
    val future = Transcoder.into(outputFile.absolutePath)
        ...
        .setListener(object : TranscoderListener {
            override fun onTranscodeProgress(progress: Double) {
                ...
                // Push progress to Flutter on the main thread
            ...
            override fun onTranscodeCompleted(successCode: Int) {
                ...
                // Ensure we emit 100% on completion
                Handler(Looper.getMainLooper()).post {
