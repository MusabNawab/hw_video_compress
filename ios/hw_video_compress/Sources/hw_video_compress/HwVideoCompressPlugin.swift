...
public class HwVideoCompressPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
  private var eventSink: FlutterEventSink?

  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "hw_video_compress", binaryMessenger: registrar.messenger())
    let progressChannel = FlutterEventChannel(name: "hw_video_compress_progress", binaryMessenger: registrar.messenger())
    
    let instance = HwVideoCompressPlugin()
